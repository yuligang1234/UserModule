...
define(function (require, exports, module) {
    ...
    exports.FixedSearch = function () {
        ...
        var parameters = { userName: userName, content: content, datetime1: datetime1, datetime2: datetime2, rows: 20, page: 1 };
        if (datetime2 < datetime1) {
            parent.window.$.messager.alert('警告', '结束时间不能小于开始时间！', 'warning');
            return;
        }
        easyui.ReloadDataGrid("#gridTool", "/Log/LoadDataGrid", parameters);
    };
